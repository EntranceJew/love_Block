...
function debug_bar.func()  
  ...
  debug_bar.debug_panel:SetPos(0, -392)
  ...
  debug_bar.lfbutton = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.lfbutton:SetImage("resources/images/silk/bug.png")
  ...
  debug_bar.console_button = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.console_button:SetImage("resources/images/silk/application_xp_terminal.png")
  ...
  debug_bar.clear_button = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.clear_button:SetImage("resources/images/silk/page_white.png")
  ...
  debug_bar.connect_button = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.connect_button:SetImage("resources/images/silk/connect.png")
  ...
  debug_bar.globals_button = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.globals_button:SetImage("resources/images/silk/controller.png")
  ...
  --[[debug_bar.video_settings = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.video_settings:SetImage("resources/images/silk/computer_edit.png")
  ...
  debug_bar.exit = loveframes.Create("imagebutton", debug_bar.toolbar)
	debug_bar.exit:SetImage("resources/images/silk/cross.png")
...
function debug_bar.ToggleConsole()
  local height = love.graphics.getHeight()
  local panelheight = debug_bar.debug_panel:GetHeight()-18
